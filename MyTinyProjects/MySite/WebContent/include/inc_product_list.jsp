...
String sql = "select count(*) from product order by publishtime desc";
...
String sql2 = "select * from product order by publishtime desc limit " + startPos + ", " + pageSize;
...
%>
              <li><a href="product_content.jsp?id=<%=rs.getInt("id") %>"><%=rs.getString("title") %></a><span><%=date %></span></li>
<% 
	if (0 == count) {
		break;
	}
...
%>
            ...
            <jsp:include page="inc_sub/inc_selector.jsp">
            	...
            	<jsp:param name="whoUseMe" value="product_list.jsp" />
            </jsp:include>
