...
<head>
	...
	<frameset rows="60px,*,24px" cols="*" name="frameAll" id="frameAll" frameborder="0" framespacing="0">
		...
		<frameset cols="180px,*" name="frameMain" id="frameMain" frameborder="0" framespacing="0" >
			<!--框架左侧-->
			<frame src="left.jsp" name="frameLeft" id="frameLeft" scrolling="no" noresize />
			<!--框架右侧-->
			<frame src="main.jsp" name="frameRight" id="frameRight" scrolling="yes" noresize style="overflow-x:hidden" />
		</frameset>
		<!--框架下部分-->
		<frame src="bottom.jsp" name="frameButtom" id="frameButtom" scrolling="no" frameborder="0" noresize />
	</frameset>
	<noframes>
